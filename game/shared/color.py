"""
file: color.py
author: authors of RobotFindsKitten
This class represents the color of a given object.
"""
...
class Color:
    ...
    def __init__(self, red, green, blue, alpha = 255):
        ...
        """
        # set private variables according to constructor parameters
        self._red = red
        self._green = green
        self._blue = blue
        self._alpha = alpha

    # returns a color as four separate values (a tuple)
    def to_tuple(self):
